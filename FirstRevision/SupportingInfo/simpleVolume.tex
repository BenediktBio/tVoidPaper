...
\Vappgeo = \wappgeo \AL
\end{equation}
Unfortunately, only the case $z_0 \geqq L_1$ was formulated explicitly\scite{Litzen1991}.
...
\begin{figure}[h]
  ...
  \caption[Skipped area section - proximal focusing, simplified approximation]{
    Simplified model of relevant skipped area sections according to literature\scite{Litzen1991} 
