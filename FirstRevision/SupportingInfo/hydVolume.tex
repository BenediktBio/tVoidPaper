...
The simplified version according to Litzén and Wahlund \scite{Litzen1991} is given in the section below.
...
\begin{equation}
  ...
  \\ \addlinespace[1ex]
     ...
     \right]_{z_0}^{L_{1}} %& \cite{Bronstein2008b}
   \\ \addlinespace[1ex]
